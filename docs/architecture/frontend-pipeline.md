...
## Phase 6 — Rotation & Nav Arrows (`src/shared/rotation.js` + `nav-controls.js`, Pro)
...
## Phase 6b — Stack (`src/shared/stack.js`, Pro)
...
## Phase 7 — Body Push (`src/shared/body-push.js`)
...
## Phase 8 — Theme Compat (`src/frontend/theme-compat.js`)
