            ...
            <span class="customize-control-title"><?php echo esc_html( $this->label ); ?></span>
              <span id="nj_color_select_text">
                  <div class="wp-picker-container wp-picker-active nj_color_select_picker">
                    <button type="button" class="button nj_color_button_select_bg" aria-expanded="true" style="<?php echo esc_html('background-color:'.$this->value()); ?>"><span class="nj-color-result-text"><?php echo _e('Select Color', NJT_NOFI_DOMAIN);?></span></button>
                    <span class="wp-picker-input-wrap nj_color_display_picker njt_nofi_none">
                        <label>
                            ...
                            <input id="_customize-input-njt_nofi_text_color" class="njt_nofi_dp_none nj-color-wp-color-picker" type="text"  value="<?php echo esc_html($this->value()); ?>" data-default="<?php echo esc_html($this->value()); ?>" data-customize-setting-link="njt_nofi_text_color">
                          </label>
